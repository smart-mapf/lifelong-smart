                                    ...
                                    int desired_t_max)
{
    ...
    // auto interval_it = std::find(all_intervals.begin(), all_intervals.end(), curr_interval);
    // Find the the first interval in all_intervals, where
    // t_min <= desired_t_min < t_max
    auto interval_it =
