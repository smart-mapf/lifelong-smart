...
void OnlineGrid::preprocessing(bool consider_rotation, std::string log_dir)
{
...
bool OnlineGrid::load_map_from_jsonstr(std::string json_str, double left_w_weight, double right_w_weight)
{
    throw std::runtime_error("OnlineGrid::load_map_from_jsonstr Not implemented");
}

void OnlineGrid::reset_weights(bool consider_rotation, std::string log_dir, bool optimize_wait, std::vector<double>& weights)
{
    throw std::runtime_error("OnlineGrid::reset_weights Not implemented");
}