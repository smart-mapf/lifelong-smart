...
void KivaGrid::parseMap(std::vector<std::vector<double>>& map_e,
...
bool KivaGrid::load_unweighted_map_from_json(json G_json, double left_w_weight,
                                             double right_w_weight) {
...
void KivaGrid::update_map_weights(std::vector<double>& new_weights) {
    // Read in weights
...
bool KivaGrid::load_weighted_map_from_json(json G_json, double left_w_weight,
                                           double right_w_weight) {
...
bool KivaGrid::load_map(std::string fname, double left_w_weight,
                        double right_w_weight) {
...
// load map
bool KivaGrid::load_unweighted_map(std::string fname, double left_w_weight,
                                   double right_w_weight) {
    std::string line;
    std::ifstream myfile((fname).c_str());
    if (!myfile.is_open()) {
...
void KivaGrid::reset_weights(bool consider_rotation, std::string log_dir,
