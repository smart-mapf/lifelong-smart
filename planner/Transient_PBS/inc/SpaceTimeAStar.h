...
public:
	...
	AStarNode(int loc, int g_val, int h_val, LLNode* parent, int timestep, int num_of_conflicts = 0, bool in_openlist = false, bool visited_goal = false) :
		LLNode(loc, g_val, h_val, parent, timestep, visited_goal, num_of_conflicts, in_openlist) {}
